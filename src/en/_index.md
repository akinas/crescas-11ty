...
<!-- ================= HERO ================= -->
<header class="hero">
  <div class="hero-mark">Florence Manuscript · 1405</div>
    ...
    <div class="grid-2 flip reveal is-in">
      <div class="plate-col">
        <div class="cover-plate">
          ...
          <div class="cover-title">Light of the Lord</div>
          <div class="cover-author">Rabbi Hasdai Crescas</div>
          <span class="tag">Critical Annotated Edition</span>
        </div>
      </div>
      <div class="hero-text">
    ...
    <div class="grid-2 reveal">
      ...
      <div class="plate-col">
        <div class="plate">
          ...
          <span>Comparison between faulty printed editions and the restored text</span>
          <span class="tag">Critical Edition</span>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="grid-2 flip reveal">
      <div class="plate-col">
        <div class="plate" style="background:linear-gradient(160deg,#e6e2d8,#d9d4c5);">
          ...
          <span>Florence Manuscript, opening folio — Author's draft</span>
...
<section class="section section-pale">
  <div class="section-inner">
    ...
    <div class="apparatus reveal">
      ...
      <div class="corr-line">
        <span class="hand-chip"><span class="hand-dot" style="background:#6fa8d6;"></span> Hand 1 — Author</span>
        <span class="word-old">וידוע כי הרצון</span>
        <span class="word-new">וידוע כי הבחירה</span>
      </div>
      <div class="corr-line">
        <span class="hand-chip"><span class="hand-dot" style="background:#aab4d1;"></span> Hand 2 — Early Proofreader</span>
        <span class="word-old">כפי שביארנו למעלה</span>
        <span class="word-new">כפי שיתבאר להלן</span>
      </div>
      <div class="corr-line">
        <span class="hand-chip"><span class="hand-dot" style="background:#e57373;"></span> Hand 3 — Late Copyist</span>
        <span class="word-old">בספר השני</span>
        <span class="word-new">בכלל השני</span>
      </div>
      <div class="corr-line">
        <span class="hand-chip"><span class="hand-dot" style="background:#d9d6cd;"></span> Hand 4 — Marginal Note</span>
        <span class="word-old">ואין ספק בדבר</span>
        <span class="word-new">ואין בזה ספק כלל</span>
      </div>

      <div class="apparatus-stats">
        <div>
          <div class="stat-num">2,000+</div>
          <div class="stat-label">Textual variants documented in the critical apparatus</div>
        </div>
        <div>
          <div class="stat-num">4</div>
          <div class="stat-label">Distinct historical scribal hands identified</div>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="grid-2 reveal">
      ...
      <div class="plate-col">
        <div class="plate" style="background:linear-gradient(160deg,#e6e2d8,#d9d4c5);">
          ...
          <span>Original orthography, abbreviations & marginal glosses</span>
          <span class="tag">Authentic Text</span>
        </div>
      </div>
    </div>
  </div>
