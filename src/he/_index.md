...
<section class="section section-pale">
  <div class="section-inner">
    ...
    <div class="apparatus reveal">
      ...
      <div class="corr-line">
        <span class="hand-chip"><span class="hand-dot" style="background:#aab4d1;"></span> יד ב׳ — מגיה קדום</span>
        <span class="word-old">כפי שביארנו למעלה</span>
        <span class="word-new">כפי שיתבאר להלן</span>
      </div>
      <div class="corr-line">
        <span class="hand-chip"><span class="hand-dot" style="background:#e57373;"></span> יד ג׳ — מעתיק מאוחר</span>
        <span class="word-old">בספר השני</span>
        <span class="word-new">בכלל השני</span>
      </div>
      <div class="corr-line">
        <span class="hand-chip"><span class="hand-dot" style="background:#d9d6cd;"></span> יד ד׳ — הגהה שולית</span>
      ...
      <div class="apparatus-stats">
        <div>
          ...
          <div class="stat-label">תיקוני נוסח ממופים באפראט המדעי</div>
        </div>
        <div>
          <div class="stat-num">4</div>
          <div class="stat-label">ידיים היסטוריות מזוהות ומסווגות</div>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="grid-2 reveal">
      <div>
        ...
        <div class="glosses">
          ...
          <div class="gloss"><div class="gloss-mark">ב</div><p>מראי מקום מדויקים למקורות הפילוסופיים</p></div>
