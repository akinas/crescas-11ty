...
<p class="lede">השוואת נוסח בין מהדורת דפוס הרב פישר לבין המהדורה הביקורתית החדשה (דניאל לוין).</p>

<div class="notice-box">
  <strong>מקרא סימנים:</strong> קטעים מודגשים (<strong>בולד</strong>) חסרים במהדורת הרב פישר. מחיקות בקו (<s>נמחק</s>) מסמנות קטעים משובשים ממהדורת הרב פישר שנמחקו או תוקנו על פי כתב היד.
</div>
